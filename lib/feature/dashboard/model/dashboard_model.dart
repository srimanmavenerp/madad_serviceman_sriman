  ...
  DashboardModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['content'] != null) {
      ...
      json['content'].forEach((v) {
        content!.add(DashboardContent.fromJson(v));
      });
    }
...
class DashboardContent {
  ...
  DashboardContent({this.topCards, this.bookingStats, this.bookings});

  DashboardContent.fromJson(Map<String, dynamic> json) {
...
class TopCards {
  ...
  TopCards.fromJson(Map<String, dynamic> json) {
    print("🔍 TopCards JSON input: $json");

    pendingBookings = int.tryParse(json['total_bookings']?.toString() ?? '0');
    ongoingBookings = int.tryParse(json['ongoing_bookings']?.toString() ?? '0');
    completedBookings = int.tryParse(json['completed_bookings']?.toString() ?? '0');
    canceledBookings = int.tryParse(json['canceled_bookings']?.toString() ?? '0');

    print(" Parsed TopCards:");
    print("   Total (Pending): $pendingBookings");
    print("   Ongoing: $ongoingBookings");
    print("   Completed: $completedBookings");
    print("   Canceled: $canceledBookings");
  }

  Map<String, dynamic> toJson() {
    return {
      'total_bookings': pendingBookings,
